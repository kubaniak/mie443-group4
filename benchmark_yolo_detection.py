...
print("Benchmarking loop iteration for 100 detections...")
orig_time = timeit.timeit(original_loop, number=100000)
print(f"Original Time (100k runs): {orig_time:.4f}s")

opt_time = timeit.timeit(optimized_loop, number=100000)
print(f"Optimized Time (100k runs): {opt_time:.4f}s")
